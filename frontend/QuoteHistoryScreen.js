...
const MAINTENANCE_ITEMS = [
  ...
  { key: "tires", label: "🔄 Tires", defaultInterval: 50000 },
                      ...
                      <View style={[styles.maintBadge,
                        ...
                        <Text style={styles.maintBadgeText}>
                          {status.milesRemaining < 0
                            ? `${Math.abs(Math.round(status.milesRemaining)).toLocaleString()} mi overdue`
      ...
      <Modal visible={showMaintenanceSetup} animationType="slide" transparent>
        <KeyboardAvoidingView style={styles.modalOverlay} behavior={Platform.OS === "ios" ? "padding" : "height"}>
          <View style={styles.modalContent}>
            ...
            <TextInput style={styles.input} placeholder={`Service interval in miles (default: ${editingMaintenance?.defaultInterval?.toLocaleString()})`} placeholderTextColor="#888" value={maintInterval} onChangeText={setMaintInterval} keyboardType="numeric" />
      ...
      <Modal visible={showAddRepair} animationType="slide" transparent>
        <KeyboardAvoidingView style={styles.modalOverlay} behavior={Platform.OS === "ios" ? "padding" : "height"}>
          <View style={styles.modalContent}>
            ...
            <ScrollView keyboardShouldPersistTaps="handled">
              <TextInput style={styles.input} placeholder="Repair name (e.g. Replaced alternator)" placeholderTextColor="#888" value={repairName} onChangeText={setRepairName} />
...
const styles = StyleSheet.create({
  ...
  maintLabel: { color: "#e8e6e0", fontSize: 14 },
  maintBadge: { borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4 },
